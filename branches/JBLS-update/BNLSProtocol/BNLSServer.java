...
public class BNLSServer extends Thread{
	...
	/** Brodcast a message to all currently connected clients. */
	public static void Broadcast(String sMessage, String sName) {
      BNLSConnectionThread bCurrent = Controller.lLinkedHead;
	  while (bCurrent != null) {
        bCurrent.sendNews("Broadcast from " + sName + ": " + sMessage);
