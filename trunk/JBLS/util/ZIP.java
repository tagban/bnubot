...
public class ZIP {
	...
	public static void main(String[] args) {
		String[] files = new String[] { "war3.exe", "game.dll", "storm.dll" };
		...
		try {
			...
			while (zipFileEntries.hasMoreElements()) {
				...
				for (int X = currentEntry.length() - 1; X >= 0; X--) {
					if ((currentEntry.charAt(X) == '\\')
							|| (currentEntry.charAt(X) == '/')) {
