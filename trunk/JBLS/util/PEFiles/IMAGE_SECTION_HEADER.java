...
public class IMAGE_SECTION_HEADER extends HEADER {
	 ...
	 * UCHAR Name[IMAGE_SIZEOF_SHORT_NAME]; : 0x00* union { * ULONG
	 * PhysicalAddress; * ULONG VirtualSize; * } Misc; : 0x04* ULONG
	 * VirtualAddress; : 0x08* ULONG SizeOfRawData; : 0x0c* ULONG
	 * PointerToRawData; : 0x10* ULONG PointerToRelocations; : 0x14* ULONG
	 * PointerToLinenumbers; : 0x18* USHORT NumberOfRelocations; : 0x20* USHORT
	 * NumberOfLinenumbers; : 0x24* ULONG Characteristics; : 0x28* } *
	 **************************************************************************/
	...
	public IMAGE_SECTION_HEADER(byte[] data) {
		create(data, 0);
	}

	public IMAGE_SECTION_HEADER(char[] data) {
		create(toByteArray(data), 0);
	}

	public IMAGE_SECTION_HEADER(byte[] data, int offset) {
		create(data, offset);
	}

	public IMAGE_SECTION_HEADER(char[] data, int offset) {
	...
	public void print(PrintStream out, int indent) {
		...
		out.println(i + "  Relocations Address:  0x"
				+ hex(PointerToRelocations));
		out.println(i + "  Line Numbers Address: 0x"
				+ hex(PointerToLinenumbers));
