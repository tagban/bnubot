...
public final class Constants {
	...
	// public static String build="Build V2.9 Remote admin, extended admin
	// commands w/ JSTR support.(01/18/06)";
	...
	public static String BotNetServer = "botnet.valhallalegends.com";
