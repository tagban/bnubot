 ...
 * 
 * Currently supports 4 "types" of output, but the system I use now sucks and
...
public class Out {
	...
	/**
	 * @param text:
	 *            Text to be send to the output stream directly(no formatting)
	 */
	...
	/**
	 * @param source:
	 *            source of the info //@param text:text to show
	 */
	...
	/**
	 * Displays errors //@param source: source of the info //@param text: text
	 * to show
	 */
	...
	/**
	 * Displays debug information, if wanted //@param source - source of the
	 * info //@param text -text to show
	 */
	 ...
	 * to system.out, admin output stream, file logging, etc..
	 * 
	 * @param s
	 ...
	 * 
	 * @author Ron -Fool Change: Moved in here instead of own TimeStamp Class
