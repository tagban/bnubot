...
public class IMAGE_EXPORT_DIRECTORY extends HEADER {
	/***************************************************************************
	 * typedef struct _IMAGE_EXPORT_DIRECTORY {* DWORD Characteristics; : 0x00 *
	 * DWORD TimeDateStamp; : 0x04 * WORD MajorVersion; : 0x08 * WORD
	 * MinorVersion; : 0x0a * DWORD Name; : 0x0c * DWORD Base; : 0x10 * DWORD
	 * NumberOfFunctions; : 0x14 * DWORD NumberOfNames; : 0x18 * DWORD
	 * AddressOfFunctions; : 0x1c * DWORD AddressOfNames; : 0x20 * DWORD
	...
	public IMAGE_EXPORT_DIRECTORY(byte[] data) {
		create(data, 0);
	}

	public IMAGE_EXPORT_DIRECTORY(char[] data) {
		create(toByteArray(data), 0);
	}

	public IMAGE_EXPORT_DIRECTORY(byte[] data, int offset) {
		create(data, offset);
	}

	public IMAGE_EXPORT_DIRECTORY(char[] data, int offset) {
	...
	public void print(PrintStream out, int indent) {
		...
		out.println(i + "  Version:           " + MajorVersion + "."
				+ MinorVersion);
