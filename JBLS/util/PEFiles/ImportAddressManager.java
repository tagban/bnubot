...
public class ImportAddressManager{
  ...
  public static void loadLibrary(String file, String prepend){
    ...
    IMAGE_EXPORT_DIRECTORY dir = new IMAGE_EXPORT_DIRECTORY(pe.getSectionsData(), pe.ntheader.OptionalHeader.DataDirectory[pe.EXPORT_TABLE].VirtualAddress);
//    dir.print(System.out);
    ...
    int high = low + pe.ntheader.OptionalHeader.DataDirectory[pe.EXPORT_TABLE].Size;
